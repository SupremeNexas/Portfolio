...
export default function ServicesSection() {
  return (
    <section id="certifications" className="bg-white rounded-t-[40px] sm:rounded-t-[50px] md:rounded-t-[60px] px-5 sm:px-8 md:px-10 py-20 sm:py-24 md:py-32">
      <h2
      ...
      <div className="max-w-5xl mx-auto">
        {services.map((service, i) => (
          <FadeIn key={i} delay={i * 0.1} y={30}>
            <div
              className="flex gap-6 md:gap-12 py-8 sm:py-10 md:py-12"
              style={{
            ...
            >
              ...
              <div className="flex flex-col justify-center">
                <h3
                  className="text-[#0C0C0C] font-medium uppercase mb-2"
